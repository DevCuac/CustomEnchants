...
public class Tools {
    ...
    public static Inventory getPreviousInventory(String name) {
        if (name.equals(prefix + "Enchantments") || name.equals(prefix + "Items") || name.equals(prefix + "Config"))
            ...
            return com.taiter.ceEnchantmentMainMenu;
        return null;
    }
    ...
    public static Inventory getNextInventory(String name) {
        ...
        if (name.equals("Enchantments"))
            ...
            return com.taiter.ceGlobalMenu;
        else if (name.equals("Bow"))
            return com.taiter.ceBowMenu;
        else if (name.equals("Helmet"))
            return com.taiter.ceHelmetMenu;
        else if (name.equals("Boots"))
            return com.taiter.ceBootsMenu;
        else if (name.equals("Armor"))
            return com.taiter.ceArmorMenu;
        else if (name.equals("Tool"))
            return com.taiter.ceToolMenu;
        return null;
    }
    ...
    public static Inventory getItemMenu(Player p) {
        if (!p.isOp() && !p.hasPermission("ce.item.*")) {
            Inventory lInv = com.taiter.ceItemMenu;
    ...
    public static void generateInventories() {
        ...
        com.taiter.ceMainMenu = MainMenu;
        ...
        com.taiter.ceEnchantmentMainMenu = EnchantmentMenu;
        // ENCHANTMENTS MENU
        ...
        com.taiter.ceArmorMenu = ArmorMenu;
        ...
        com.taiter.ceGlobalMenu = GlobalMenu;
        ...
        com.taiter.ceToolMenu = ToolMenu;
        ...
        com.taiter.ceHelmetMenu = HelmetMenu;
        ...
        com.taiter.ceBootsMenu = BootsMenu;
        // SPECIFIC MENUS
        ...
        com.taiter.ceItemMenu = ItemMenu;
        // ITEM MENU
